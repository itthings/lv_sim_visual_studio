...
static void controls_create(lv_obj_t* parent)
{
    ...
    lv_obj_set_pos(labelOutTitle, 30, 97);
   ...
   // lv_obj_set_style_local_text_font(labelOutside, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, &lv_font_roboto_bold_16);
    ...
    lv_obj_set_pos(labelOutside, 55, 116);
    ...
    lv_obj_set_pos(labelOutsideDegrees, 95, 111);
    ...
    lv_obj_set_pos(labelOutsideHumidity, 16, 137);
    ...
    lv_obj_align(line1, NULL, LV_ALIGN_CENTER, -3, 24);
    ...
    lv_obj_align(line2, NULL, LV_ALIGN_CENTER, -3, 88);
