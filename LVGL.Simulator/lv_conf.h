...
#define  LV_FONT_CUSTOM_DECLARE \
  LV_FONT_DECLARE(lv_font_roboto_black_50) \
  LV_FONT_DECLARE(lv_font_roboto_reg_10) \
  LV_FONT_DECLARE(lv_font_roboto_reg_12) \
  LV_FONT_DECLARE(lv_font_roboto_reg_14) \
  LV_FONT_DECLARE(lv_font_roboto_reg_16) \
  LV_FONT_DECLARE(lv_font_roboto_reg_50) \
...
LV_FONT_DECLARE(lv_font_roboto_bold_14) \
  LV_FONT_DECLARE(lv_font_roboto_bold_16) \
    LV_FONT_DECLARE(lv_font_roboto_bold_40) \
      LV_FONT_DECLARE(lv_font_roboto_bold_30) \
        LV_FONT_DECLARE(lv_font_roboto_bold_16) \
  LV_FONT_DECLARE(lv_font_roboto_bold_18) \
  LV_FONT_DECLARE(lv_font_roboto_bold_14)\
  LV_FONT_DECLARE(lv_font_roboto_bold_50)
